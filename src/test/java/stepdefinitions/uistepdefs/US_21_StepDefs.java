...
public class US_21_StepDefs {
    ...
    public void us21_user_selects_the_doctor_who_is_the_current_doctor() {
        ...
        Driver.wait(4);
        Driver.waitAndClick(staffPage.physicanSelectBoxUnderAppointments);
        Driver.wait(6);
    ...
    public void us21_user_clicks_show_tests_button() {
        Driver.waitAndClick(staffPage.showTestForTeamEightyNineDoctor);
        Driver.wait(3);
    }
    @Then("US21 User clicks View Results button")
    public void us21_user_clicks_view_results_button() {
        Driver.waitAndClick(staffPage.staffCanSeeTestResultButton);
        Driver.wait(3);
